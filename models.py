...
# .env dosyasını yükle (absolute path ile)
load_dotenv('/var/www/cosmofinder/backend/.env')
...
class User:
    def __init__(self, username, email, password_hash=None, first_name=None, last_name=None, 
                 ...
                 push_token="", notification_settings=None):  # Push notification alanları eklendi
        ...
        self.notification_settings = notification_settings or {
            ...
            "weekly_summaries": True,          # Haftalık fal özetleri
            "premium_notifications": True,     # Premium bildirimleri
            "fal_result_notifications": True,  # Fal sonucu bildirimleri
            "new_feature_notifications": True, # Yeni özellik bildirimleri
    ...
    def get_token_balance(self):
        """Kullanıcının güncel token bakiyesini hesapla"""
        try:
            pipeline = [
...
def calculate_zodiac_sign(birth_date_str, language="tr"):
    ...
    try:
        ...
        if (month == 3 and day >= 21) or (month == 4 and day <= 19):
            return "Aries" if language == "en" else "Widder" if language == "de" else "Koç"
        elif (month == 4 and day >= 20) or (month == 5 and day <= 20):
            return "Taurus" if language == "en" else "Stier" if language == "de" else "Boğa"
        elif (month == 5 and day >= 21) or (month == 6 and day <= 20):
            return "Gemini" if language == "en" else "Zwillinge" if language == "de" else "İkizler"
        elif (month == 6 and day >= 21) or (month == 7 and day <= 22):
            return "Cancer" if language == "en" else "Krebs" if language == "de" else "Yengeç"
        elif (month == 7 and day >= 23) or (month == 8 and day <= 22):
            return "Leo" if language == "en" else "Löwe" if language == "de" else "Aslan"
        elif (month == 8 and day >= 23) or (month == 9 and day <= 22):
            return "Virgo" if language == "en" else "Jungfrau" if language == "de" else "Başak"
        elif (month == 9 and day >= 23) or (month == 10 and day <= 22):
            return "Libra" if language == "en" else "Waage" if language == "de" else "Terazi"
        elif (month == 10 and day >= 23) or (month == 11 and day <= 21):
            return "Scorpio" if language == "en" else "Skorpion" if language == "de" else "Akrep"
        elif (month == 11 and day >= 22) or (month == 12 and day <= 21):
            return "Sagittarius" if language == "en" else "Schütze" if language == "de" else "Yay"
        elif (month == 12 and day >= 22) or (month == 1 and day <= 19):
            return "Capricorn" if language == "en" else "Steinbock" if language == "de" else "Oğlak"
        elif (month == 1 and day >= 20) or (month == 2 and day <= 18):
            return "Aquarius" if language == "en" else "Wassermann" if language == "de" else "Kova"
        else:
            return "Pisces" if language == "en" else "Fische" if language == "de" else "Balık"
    except:
        return None
...
class PremiumSubscription:
    def __init__(self, user_id, plan_type, start_date=None, end_date=None, 
        ...
        self.user_id = user_id
        self.plan_type = plan_type  # 'premium', 'premium_plus'
...
PREMIUM_PRICES = {
    ...
    'premium_plus_monthly': 49.99,
    'premium_plus_yearly': 499.99
} 